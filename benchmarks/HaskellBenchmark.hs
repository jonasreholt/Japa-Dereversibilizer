  ...
  defaultMain
    [
      ...
      , bgroup "Perm-to-code tests"
        ...
        , bench "Program (Inv)"   $ whnfAppIO compiler ["benchmarks/perm-to-code-opt.japa"]
        , bench "Program (Inv-noOpt)" $ whnfAppIO compiler ["-noOpt", "benchmarks/perm-to-code-opt.japa"]
        ]
