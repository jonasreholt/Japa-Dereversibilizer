...
PROGRAM6="../benchmarks/perm-to-code-opt.japa"
...
COPROGRAM6="perm-to-code-opt.cpp"
...
do
    ...
    ./$OEXEC6
    END=$(date +%N)
    OPROGRAM6DUR=$[ $OPROGRAM6DUR + $[ END - START ] ]
done
